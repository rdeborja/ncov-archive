...
def main():
    ...
    submission_to = 'gisaid'
    today = datetime.datetime.now()
    outfile_prefix = f'{today.strftime("%Y%m%d")}_{config["sample_collected_by_short"]}_{submission_to}'
    outfile_fasta = f'{outfile_prefix}.fasta'
    outfile_meta = f'{outfile_prefix}.csv'
    ...
    with open(outfile_fasta, "w") as fasta_out:
